...
def predict_game(home_name: str, away_name: str) -> dict:
    ...
    return {
        ...
        "home_pitcher_hand":          (home_pitcher_info or {}).get("hand"),
        "home_pitcher_recent_starts": (home_pitcher_info or {}).get("recent_starts", []),
        ...
        "away_pitcher_hand":          (away_pitcher_info or {}).get("hand"),
        "away_pitcher_recent_starts": (away_pitcher_info or {}).get("recent_starts", []),
